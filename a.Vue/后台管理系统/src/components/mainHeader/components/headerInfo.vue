...
import { LOGIN_MENUINFO, LOGIN_PERMISSIONS, LOGIN_TOKEN, LOGIN_USERINFO } from "@/utils/constants";

const handleExitLogin = () => {
  localCache.deleteCache(LOGIN_TOKEN);
  localCache.deleteCache(LOGIN_MENUINFO);
  localCache.deleteCache(LOGIN_USERINFO);
  localCache.deleteCache(LOGIN_PERMISSIONS);
  router.push("/login");
};
