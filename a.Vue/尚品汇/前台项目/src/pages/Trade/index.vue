  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p>
          <span class="s1">{{ a.userAddress }}</span>
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(o, index) in OrderInfo.detailArrayList"
          :key="index"
        >
          <li>
...
export default {
  ...
  methods: {
    ...
    async SubmitOrder() {
      ...
      let params = {
        consignee: this.UserAddressDefault.consignee,
        consigneeTel: this.UserAddressDefault.phoneNum,
        deliveryAddress: this.UserAddressDefault.fullAddress,
        paymentWay: "ONLINE",
        orderComment: this.msg,
        orderDetailList: this.OrderInfo.detailArrayList,
      };

      let result = (await this.$API.reqSubOrder(tradeNo, params)).data;
      if (result.code == 200) {
        this.tradeId = result.data;
        this.$router.push("/Pay?tradeId=" + this.tradeId);
      } else {
        console.log(result);
      }
    },
