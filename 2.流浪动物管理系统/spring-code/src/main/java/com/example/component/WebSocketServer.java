...
public class WebSocketServer {
     ...
     */
    @OnOpen
    public void onOpen(Session session, @PathParam("username") String username) {//记录登录用户，统计在线人数，将用户存放sessionMap
     ...
     */
    @OnClose
    public void onClose(Session session, @PathParam("username") String username) {//用户退出处理
